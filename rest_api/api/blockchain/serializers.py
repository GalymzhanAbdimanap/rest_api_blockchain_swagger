...
transfer_token = api.model('transfer_token', {
    'account_address': fields.String(readOnly=True, description='Account address on Blockchain.'),
    'privateKey':fields.String(readOnly=True, description='Private key of account on Blockchain.'),
    'value':fields.Integer(readOnly=True, description='The amount of Token for transfer.'),

})
getToken = api.model('getToken', {
    'account_address': fields.String(readOnly=True, description='Account address on Blockchain.'),
})
createGoods = api.model('createGoods', {
    'account_address': fields.String(readOnly=True, description='Account address on Blockchain.'),
    'privateKey':fields.String(readOnly=True, description='Private key of account on Blockchain.'),
    'title':fields.String(readOnly=True, description='Title for good.'),
    'startPrice':fields.Integer(readOnly=True, description='Start price for one good.'),
    'description':fields.String(readOnly=True, description='Description for food.'),
    'count':fields.Integer(readOnly=True, description='How many pieces for sales.'),
    'comission':fields.Integer(readOnly=True, description='Comission for one piece.'),
})
